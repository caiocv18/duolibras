...
class AppBarWidget extends StatelessWidget implements PreferredSizeWidget {
  ...
  late var appBar = AppBar(
        ...
        title: Container(
            child: GradientText(
                ...
                gradient: 
                LinearGradient(colors: [HexColor.fromHex("4982F6"), HexColor.fromHex("2CC4FC")],
  ...
  AppBarWidget(this._title, {required this.longpressHandler, required this.backButtonPressed});
