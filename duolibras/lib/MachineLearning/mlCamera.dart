...
class MLCamera {
  ...
  IL.Image? _handleAndroidImage(CameraImage image) {
    ...
    try {
      ...
      var img = IL.Image.fromBytes(width, height, image.planes.first.bytes,
      ...
      // IL.PngEncoder pngEncoder = new IL.PngEncoder(level: 0, filter: 0);
      // List<int> png = pngEncoder.encodeImage(img);
      // return IL.Image.fromBytes(img.width, img.height, png);
